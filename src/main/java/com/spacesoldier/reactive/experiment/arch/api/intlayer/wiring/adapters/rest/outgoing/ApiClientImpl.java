...
public class ApiClientImpl extends JavaTimeFormatter {
    ...
    public ApiClientImpl(ObjectMapper mapper, DateFormat format) {
        this(buildWebClient(mapper.copy()), format);
    }

    public ApiClientImpl(WebClient webClient, ObjectMapper mapper, DateFormat format) {
        this(Optional.ofNullable(webClient).orElseGet(() -> buildWebClient(mapper.copy())), format);
    }

    private ApiClientImpl(WebClient webClient, DateFormat format) {
    ...
    */
     ...
     */
    public ApiClientImpl setBasePath(String basePath) {
        this.basePath = basePath;
        return this;
    }
     ...
     * @return ApiClient this client
     */
    public ApiClientImpl setUserAgent(String userAgent) {
     ...
     * @return ApiClient this client
     */
    public ApiClientImpl addDefaultHeader(String name, String value) {
     ...
     * @return ApiClient this client
     */
    public ApiClientImpl addDefaultCookie(String name, String value) {
