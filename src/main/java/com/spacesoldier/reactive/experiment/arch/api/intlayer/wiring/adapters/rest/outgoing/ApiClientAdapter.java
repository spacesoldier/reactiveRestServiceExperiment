...
import com.spacesoldier.reactive.experiment.arch.api.intlayer.wiring.adapters.rest.outgoing.model.auth.HttpBearerAuth;
...
public class ApiClientAdapter extends JavaTimeFormatter {
    ...
    public ApiClientAdapter(String basePath) {
    ...
    public ApiClientAdapter(WebClient webClient) {
        this(Optional.ofNullable(webClient).orElseGet(() -> buildWebClient()), createDefaultDateFormat());
    }

    public ApiClientAdapter(ObjectMapper mapper, DateFormat format) {
        this(buildWebClient(mapper.copy()), format);
    }

    public ApiClientAdapter(WebClient webClient, ObjectMapper mapper, DateFormat format) {
        this(Optional.ofNullable(webClient).orElseGet(() -> buildWebClient(mapper.copy())), format);
    }

    private ApiClientAdapter(WebClient webClient, DateFormat format) {
    ...
    */
     ...
     */
    public ApiClientAdapter setBasePath(String basePath) {
        this.basePath = basePath;
        return this;
    }
     ...
     * @return ApiClient this client
     */
    public ApiClientAdapter setUserAgent(String userAgent) {
     ...
     * @return ApiClient this client
     */
    public ApiClientAdapter addDefaultHeader(String name, String value) {
     ...
     * @return ApiClient this client
     */
    public ApiClientAdapter addDefaultCookie(String name, String value) {
